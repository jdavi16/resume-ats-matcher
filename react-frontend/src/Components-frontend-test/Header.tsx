...
const Header: React.FC = () => {
  ...
  return (
    <header className='navbar bg-base-100 h-[84px] mb-[120px] border-b border-base-300 px-4 md:px-8'>
      <div className='navbar-start'>
        <h1 className='text-3xl font-black ml-5 select-none whitespace-nowrap'>Resume ATS Matcher</h1>
      </div>
      <div className='navbar-end gap-3'>
        <label className='btn btn-ghost btn-square border border-base-300 swap swap-rotate'>
